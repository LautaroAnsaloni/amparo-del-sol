...
export default function CabinCarousel() {
  ...
  const navigateEnlargedImage = (direction: "prev" | "next") => {
    ...
    const newIndex =
      direction === "prev"
        ? (enlargedImageIndex - 1 + houseImages.length) % houseImages.length
        : (enlargedImageIndex + 1) % houseImages.length;
              ...
              <div
                className={`relative w-full h-full transition-all duration-300 ${
                  index === selectedIndex
                    ...
                    : index ===
                        (selectedIndex - 1 + houseImages.length) %
                          houseImages.length ||
                      index === (selectedIndex + 1) % houseImages.length
      ...
      {enlargedImageIndex !== null && (
        ...
        >
          <div className="relative w-full h-full">
            <Image
              src={houseImages[enlargedImageIndex]}
